...
insert into Company values('CompanyA', 'Mercado way','USA','1437',null,'Fu')
insert into Project values('ProjectA',null,null,1500000,'Park',10)
insert into ProjectManage values(1,'CompanyA','Mercado way','USA')
...
insert into Lender values('Fu',9999999)
...
insert into Description values(2,'CourseB',null,'Fu')
